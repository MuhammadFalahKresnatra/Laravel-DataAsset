        ...
        <div class="card-body">
            <form action="{{ route('asset.perbaikanstore') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group" hidden>
                        ...
                        <input type="number" class="form-control @error('idasset') is-invalid @enderror" name="idasset" id="idasset" autocomplete="off" value="{{ $idasset }}">
                    @error('tgl')
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" id="keterangan" placeholder="Keterangan" autocomplete="off" value="{{ old('keterangan') }}"></textarea>
                @error('keterangan')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
                </div>
